...
SELECT P_CODE, P_INDATE, now()::DATE - 90 AS CUTDATE
FROM   PRODUCT
WHERE  P_INDATE <= now()::DATE - 90;
...
SELECT V_CODE, V_NAME
FROM   VENDOR 
WHERE  V_CODE NOT IN (SELECT DISTINCT V_CODE FROM PRODUCT WHERE V_CODE IS  NULL);
